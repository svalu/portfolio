    ...
    Trumbowyg.prototype = {
            ...
            var t = this,
                ...
                $btn = $('<button/>', {
                    ...
                    html: t.hasSvg && hasIcon ?
                        '<svg><use xlink:href="' + t.svgPath + '#' + prefix + (btn.ico || btnName).replace(/([A-Z]+)/g, '-$1').toLowerCase().replace('base64','insert-image') + '"/></svg>' :
        ...
        buildSubBtn: function (btnName) {
            ...
            return $('<button/>', {
                ...
                html: t.hasSvg && hasIcon ?
                    '<svg><use xlink:href="' + t.svgPath + '#' + prefix + (btn.ico || btnName).replace(/([A-Z]+)/g, '-$1').toLowerCase().replace('base64','insert-image') + '"/></svg>' + (btn.text || btn.title || t.lang[btnName] || btnName) :
