  ...
  var settings = {}, roots = {}, caches = {},
    ...
    view = {
      ...
      makeDOMNodeMainBefore: function (html, setting, node) {
		html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' name='notepadTitle' data-ismenuable='true' treenode>");
      },
      ...
      makeDOMNodeNameBefore: function (html, setting, node) {
        ...
        html.push("<a data-id='"+node.id+"' data-ismenuable='"+node.categIsUse+"' id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level,
    ...
    init: function (obj, zSetting, zNodes) {
      ...
      var zTreeTools = {
        ...
        addNodes: function (parentNode, index, newNodes, isSilent) {
					//console.log("jquery.ztre.core.js addNodes");
